// Peticion de ajax
var ajax = {
    cargarArchivo: function(ruta) { // A esta funcion le damos una ruta que son todas las carpetas hasta el archivo que queremos.
        ...
        peticion.onreadystatechange = function() { 
           ...
           if(peticion.readyState == XMLHttpRequest.DONE){
               if(peticion.status == 200) { // 200 es un codigo que significa que todo esta bien
