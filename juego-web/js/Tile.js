function Tile(xEnTiles, yEnTiles, z, ancho, alto, sprite){
    ...
    this.zIndex = z;
    this.sprite = sprite;
    this.idHTML = "x" + xEnTiles +"y"+ yEnTiles + "z";//este es el sistema de coordenadas
    this.html = '<div id="'+ this.idHTML +'"> </div>';

}
Tile.prototype.aplicarEstilos = function(){
    if(!document.getElemenyById(this.idHTML)){//con esto comprobamos si los estilos estan cargados y que nos devuelva un error avisandosno
